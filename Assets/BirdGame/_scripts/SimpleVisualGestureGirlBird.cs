...
public class SimpleVisualGestureGirlBird : MonoBehaviour, VisualGestureListenerInterface
{
				...
				else 
				{
					...
					if (curentTimerValue<0)
					{
						...
						foreach (var i in tempGestures)
						{
							...
							else if (i=="Arm60_Right") temp.Add(60);
							else temp.Add(30);
	...
	public void Update ()
	{
		...
		if (firstPart && secondPart && thirdPart && fourthPart && fifthPart&&! isFinish)
		{
		...
		if (isFinish) 
		{
			...
			Application.LoadLevel("MainBird");
